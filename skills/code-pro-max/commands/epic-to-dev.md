---
description: Plan the rest of the package (tech spec, ADR, tickets, release ticket, stakeholder report) from an already-written epic
argument-hint: [epic content, pasted or a path to it]
disable-model-invocation: false
---

Load and follow [`../SKILL.md`](../SKILL.md), specifically the **"Alternate
Entry Point — Epic → Dev"** section, and its `references/` and
...
missing. Never implement code changes from this command alone — that
