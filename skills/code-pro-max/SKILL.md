...
by supplying epic content directly, e.g. `/epic-to-dev {{epic content}}`.
...
| Epic → Dev | `/epic-to-dev {{epic content}}` — skip Discover/Select, plan the rest from a developer-supplied epic |
